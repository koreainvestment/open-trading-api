...
output1, output2 = display_board_top(fid_cond_mrkt_div_code="F", fid_input_iscd="101V06")
print(output1)
print(output2)
...
result1, result2 = exp_price_trend(fid_input_iscd="101V06", fid_cond_mrkt_div_code="F")
print(result1)
print(result2)
...
result1, result2 = inquire_asking_price(fid_cond_mrkt_div_code="F", fid_input_iscd="101S03", env_dv="real")
print(result1)
print(result2)
