...
종목은 삼성전자로 설정하였고, 매도전략과 매수전략 모두 전일 종가 기준으로 일정 비율 이상 변동할 경우, 보유 수량의 일정 비율을 매도하는 방식으로 하였고, 매도비율을 더 높게 함으로써 이익을 더 많이 내도록 설정하였습니다. 매매는 30분 기준으로 행동하도록 설정하였습니다. 
...
6. auto_paper_trading2 (두산, 000150)
...
두산의 백테스팅 결과를 반영하여 삼성전자의 실제 모의투자 파일(auto_paper_trading.py)의 매매 공식도 업데이트 하였습니다. 
