...
def display_board_callput(
    ...
    Example:
        >>> df1, df2 = display_board_callput("O", "20503", "CO", "202407", "PO")
        >>> print(df1)
        >>> print(df2)
    """
...
def exp_price_trend(
    ...
    Example:
        >>> df1, df2 = exp_price_trend(fid_input_iscd="101V06", fid_cond_mrkt_div_code="F")
        >>> print(df1)
        >>> print(df2)
    """
...
def inquire_asking_price(
    ...
    Example:
        >>> df1, df2 = inquire_asking_price("F", "101S03", "real")
        >>> print(df1)
        >>> print(df2)
    """
