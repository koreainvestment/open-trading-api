...
def main():
    ...
    Example:
        >>> df1, df2 = dailyprice(auth="", excd="NYS", symb="TSLA", gubn="0", bymd="", modp="1", env_dv="real")  # 실전투자
        >>> df1, df2 = dailyprice(auth="", excd="NYS", symb="TSLA", gubn="0", bymd="", modp="1", env_dv="demo")  # 모의투자
    """
    try:
        # pandas 출력 옵션 설정
