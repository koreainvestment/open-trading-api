...
Traceback (most recent call last):
  File "/workspaces/open-trading-api/samsung_auto_trader/trader.py", line 111, in run
    self._run_one_cycle()
  File "/workspaces/open-trading-api/samsung_auto_trader/trader.py", line 136, in _run_one_cycle
    buy_order = self.orders.place_limit_order("buy", self.symbol, self.order_quantity, buy_price)
                ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/workspaces/open-trading-api/samsung_auto_trader/orders.py", line 55, in place_limit_order
    response = self.client.post(
               ^^^^^^^^^^^^^^^^^
  File "/workspaces/open-trading-api/samsung_auto_trader/api_client.py", line 60, in post
    return self._request("POST", path, tr_id, body=body, tr_cont=tr_cont, use_hashkey=use_hashkey)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/workspaces/open-trading-api/samsung_auto_trader/api_client.py", line 143, in _request
    raise RuntimeError(f"Request failed after retries: {method} {path}") from last_error
RuntimeError: Request failed after retries: POST /uapi/domestic-stock/v1/trading/order-cash
2026-05-30 04:52:10,542 | INFO | samsung_auto_trader | sleeping before next poll: 180s
2026-06-01 03:31:40,899 | INFO | samsung_auto_trader | starting Samsung auto trader for 005930
2026-06-01 03:31:40,912 | INFO | samsung_auto_trader | trading window configured: 09:10:00 - 15:30:00
2026-06-01 03:31:40,913 | INFO | samsung_auto_trader | trading window started
2026-06-01 03:31:40,913 | INFO | samsung_auto_trader | token refresh: requesting a new mock-trading token
2026-06-01 03:31:43,977 | INFO | samsung_auto_trader | token refresh: token cached at /workspaces/open-trading-api/samsung_auto_trader/token_cache.json
2026-06-01 03:31:46,851 | INFO | samsung_auto_trader | current price: symbol=005930 price=349,000
2026-06-01 03:31:46,851 | INFO | samsung_auto_trader | token reuse: cached token reused for 2026-06-01
2026-06-01 03:31:52,834 | INFO | samsung_auto_trader | holdings snapshot: cash=7,000,586 available=7,000,586 holdings=1
2026-06-01 03:31:52,834 | INFO | samsung_auto_trader | holdings before order: symbol=005930 qty=18 cash=7,000,586 available=7,000,586 total=13,278,086
2026-06-01 03:31:52,834 | INFO | samsung_auto_trader | buy order request: symbol=005930 current=349,000 target=348,000 quantity=1
2026-06-01 03:31:52,834 | INFO | samsung_auto_trader | buy order request: symbol=005930 quantity=1 price=348,000
2026-06-01 03:31:52,835 | INFO | samsung_auto_trader | token reuse: cached token reused for 2026-06-01
2026-06-01 03:31:57,032 | INFO | samsung_auto_trader | buy order accepted: order_no=unknown
2026-06-01 03:32:02,033 | INFO | samsung_auto_trader | token reuse: cached token reused for 2026-06-01
2026-06-01 03:32:09,074 | INFO | samsung_auto_trader | holdings snapshot: cash=7,000,586 available=7,000,586 holdings=1
2026-06-01 03:32:09,075 | INFO | samsung_auto_trader | holdings after buy: symbol=005930 qty=18 cash=7,000,586 available=7,000,586 total=13,278,086
2026-06-01 03:32:09,075 | INFO | samsung_auto_trader | buy execution check: no clear execution signal (qty 18 -> 18, cash 7,000,586 -> 7,000,586)
2026-06-01 03:32:09,075 | INFO | samsung_auto_trader | sell order request: symbol=005930 current=349,000 target=350,000 quantity=1
2026-06-01 03:32:09,075 | INFO | samsung_auto_trader | sell order request: symbol=005930 quantity=1 price=350,000
2026-06-01 03:32:09,075 | INFO | samsung_auto_trader | token reuse: cached token reused for 2026-06-01
2026-06-01 03:32:15,174 | INFO | samsung_auto_trader | sell order accepted: order_no=unknown
2026-06-01 03:32:20,174 | INFO | samsung_auto_trader | token reuse: cached token reused for 2026-06-01
2026-06-01 03:32:25,089 | INFO | samsung_auto_trader | holdings snapshot: cash=7,000,586 available=7,000,586 holdings=1
2026-06-01 03:32:25,090 | INFO | samsung_auto_trader | holdings after sell: symbol=005930 qty=18 cash=7,000,586 available=7,000,586 total=13,278,086
2026-06-01 03:32:25,090 | INFO | samsung_auto_trader | sell execution check: no clear execution signal (qty 18 -> 18, cash 7,000,586 -> 7,000,586)
2026-06-01 03:32:25,090 | INFO | samsung_auto_trader | sleeping before next poll: 180s
2026-06-01 03:35:25,090 | INFO | samsung_auto_trader | token reuse: cached token reused for 2026-06-01
2026-06-01 03:35:28,570 | INFO | samsung_auto_trader | current price: symbol=005930 price=348,000
2026-06-01 03:35:28,570 | INFO | samsung_auto_trader | token reuse: cached token reused for 2026-06-01
2026-06-01 03:35:34,941 | INFO | samsung_auto_trader | holdings snapshot: cash=7,000,586 available=6,652,546 holdings=1
2026-06-01 03:35:34,942 | INFO | samsung_auto_trader | holdings before order: symbol=005930 qty=19 cash=6,652,546 available=6,652,546 total=13,264,546
2026-06-01 03:35:34,942 | INFO | samsung_auto_trader | buy order request: symbol=005930 current=348,000 target=347,000 quantity=1
2026-06-01 03:35:34,942 | INFO | samsung_auto_trader | buy order request: symbol=005930 quantity=1 price=347,000
2026-06-01 03:35:34,942 | INFO | samsung_auto_trader | token reuse: cached token reused for 2026-06-01
2026-06-01 03:35:39,426 | INFO | samsung_auto_trader | buy order accepted: order_no=unknown
2026-06-01 03:35:44,426 | INFO | samsung_auto_trader | token reuse: cached token reused for 2026-06-01
2026-06-01 03:35:51,279 | INFO | samsung_auto_trader | holdings snapshot: cash=7,000,586 available=6,652,546 holdings=1
2026-06-01 03:35:51,279 | INFO | samsung_auto_trader | holdings after buy: symbol=005930 qty=19 cash=6,652,546 available=6,652,546 total=13,269,296
2026-06-01 03:35:51,279 | INFO | samsung_auto_trader | buy execution check: no clear execution signal (qty 19 -> 19, cash 6,652,546 -> 6,652,546)
2026-06-01 03:35:51,279 | INFO | samsung_auto_trader | sell order request: symbol=005930 current=348,000 target=349,000 quantity=1
2026-06-01 03:35:51,280 | INFO | samsung_auto_trader | sell order request: symbol=005930 quantity=1 price=349,000
2026-06-01 03:35:51,280 | INFO | samsung_auto_trader | token reuse: cached token reused for 2026-06-01
2026-06-01 03:35:56,183 | INFO | samsung_auto_trader | sell order accepted: order_no=unknown

실제 매수와 매도 주문이 들어가 거래가 진행된 것을 확인할 수 있다
